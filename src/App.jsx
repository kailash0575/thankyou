...
SEO" />
            ...
            <div className="right_proposal_section">
              <form className='form_container'>
                ...
                <div className="button_container">
                  <button className='form_button' id='proposal_button' type='submit' > Get a Free Marketing Plan</button>
      ...
      <div className="footer_container_main">
        ...
        <div className="footer_bottom_container">
          ...
          <div className="footer_bottom_item"><img src={hubspot} alt="googlepartner" /></div>
          <div className="footer_bottom_item"> <img src={meta} alt="meta" /> </div>
          <div className="footer_bottom_item"> <img src={aws} alt="aws" /> </div>
        </div>
      </div>
    </div>
  )
